window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			// entries ordered by `order` (pre-0.1.2 generator+priority is gone).
			ctx.slots.inject("conversation.chat.assistant-actions", function () {
				...
				var disposeFeedback = ctx.slots.register({ name: "conversation.chat.assistant-actions", id: "feedback", order: -10 }, NullCell);
